                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('discount_type') is-invalid @enderror"
                                            ...
                                            <option value="percentage" {{ old('discount_type')=='percentage'
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('discount_value') is-invalid @enderror"
                                            name="discount_value" type="number" value="{{ old('discount_value') }}"
                                            required min="0" step="0.01"
                                            placeholder="e.g., 10 for 10% or 50000 for Rp50,000">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('minimum_amount') is-invalid @enderror"
                                            name="minimum_amount" type="number" value="{{ old('minimum_amount', 0) }}"
                                            required min="0" step="1000" placeholder="e.g., 100000">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('maximum_discount') is-invalid @enderror"
                                            name="maximum_discount" type="number" value="{{ old('maximum_discount') }}"
                                            min="0" step="1000" placeholder="Optional, e.g., 100000">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('usage_limit') is-invalid @enderror"
                                            name="usage_limit" type="number" value="{{ old('usage_limit') }}" min="1"
